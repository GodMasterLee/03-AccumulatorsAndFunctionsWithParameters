...
def run_test_even_better_draw_circles(a,n,color):
    print()
    print('--------------------------------------------------')
    print('Testing  better_draw_circles:  See graphics window')
    print('--------------------------------------------------')
    even_better_draw_circles(a,n,color)


def even_better_draw_circles(a,n,color):
    window = rg.RoseWindow(400, 400)
    center = rg.Point(200, 200)
...
# ----------------------------------------------------------------------
main()
run_test_even_better_draw_circles(10,20,'green')